...
select p.productCode, o.orderNumber, p.productDescription from products p inner join orderdetails o on p.productCode = o.productCode;
...
select employees.firstName, employees.officeCode, employees.jobTitle, offices.phone, offices.country from employees inner join offices on employees.officeCode = offices.officeCode;

select e.firstName, e.lastName, e.officeCode, e.jobTitle, o.phone, o.country from employees e inner join offices o on e.officeCode > 4;

select e.firstName, e.lastName, e.officeCode, e.jobTitle, o.phone, o.country from employees e left join offices o on e.officeCode = o.officeCode;

select e.firstName, e.lastName, e.officeCode, e.jobTitle, o.phone, o.country from employees e right join offices o on e.officeCode = o.officeCode;

select e.firstName, e.lastName, e.officeCode, e.jobTitle, o.phone, o.country from employees e join offices o on e.officeCode = o.officeCode;
